...
(function ($, document) {
    $.glisse = function (element, options) {
        ...
        var createElements = function createElements() {
            ...
            plugin.els['close']         = $(document.createElement('div')).attr({'id':'glisse-close','class':'icon-close'}).css(cssProp, cssVal);
            ...
            plugin.els['controlNext']   = $(document.createElement('div')).attr('class','glisse-next')
                                            .append( $(document.createElement('a')).html('&nbsp;').attr({"href":"#", "class":"icon-arrow-right3"}));
            plugin.els['controlLegend'] = $(document.createElement('div')).attr('class','glisse-legend');
            plugin.els['controlPrev']   = $(document.createElement('div')).attr('class','glisse-prev')
                                            .append($(document.createElement('a')).html('&nbsp;').attr({"href":"#", "class":"icon-arrow-left3"}));
